...
var recentMsgs : [RecentMessage] = [
    ...
    RecentMessage( lastMsg: "Apple Tech", lastMsgTime: "15:00", pendingMsgs: "9", userName: "Jenna Ezarik", userImage: "p4", allMsgs: Eachmsg.shuffled()),
    ...
    ,RecentMessage( lastMsg: "My name is park !!!", lastMsgTime: "14:39", pendingMsgs: "1", userName: "park", userImage: "p2", allMsgs: Eachmsg.shuffled())
